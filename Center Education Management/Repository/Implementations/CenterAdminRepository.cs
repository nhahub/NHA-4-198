...
{
    public class CenterAdminRepository : GenericRepository<CenterAdmin>, ICenterAdminRepository
    {
        public CenterAdminRepository(CenterDBContext context) : base(context)
        {
        }
    }
}
