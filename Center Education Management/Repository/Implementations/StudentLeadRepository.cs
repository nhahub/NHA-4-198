...
{
    public class StudentLeadRepository : GenericRepository<StudentLead>, IStudentLeadRepository
    {
        public StudentLeadRepository(CenterDBContext context) : base(context)
        {
        }
    }
}
